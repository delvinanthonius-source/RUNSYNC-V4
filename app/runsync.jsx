...
/* ═══════════ INDONESIAN FOOD DATABASE (60+ items) ═══════════ */
const FOOD_DB=[
  // Nasi & Karbohidrat
  {id:1,name:"Nasi Putih",portion:"1 piring (150g)",cal:195,carb:43,protein:4,fat:0.3,cat:"Karbohidrat",emoji:"🍚"},
  {id:2,name:"Nasi Goreng",portion:"1 piring",cal:450,carb:55,protein:12,fat:18,cat:"Karbohidrat",emoji:"🍳"},
  {id:3,name:"Nasi Uduk",portion:"1 piring",cal:390,carb:52,protein:8,fat:16,cat:"Karbohidrat",emoji:"🍚"},
  {id:4,name:"Lontong/Ketupat",portion:"2 potong",cal:160,carb:36,protein:3,fat:0.2,cat:"Karbohidrat",emoji:"🍙"},
  {id:5,name:"Mie Goreng Indomie",portion:"1 bungkus",cal:380,carb:50,protein:8,fat:16,cat:"Karbohidrat",emoji:"🍜"},
  {id:6,name:"Oatmeal",portion:"1 mangkok (40g)",cal:150,carb:27,protein:5,fat:3,cat:"Karbohidrat",emoji:"🥣"},
  {id:7,name:"Roti Gandum",portion:"2 lembar",cal:140,carb:26,protein:6,fat:2,cat:"Karbohidrat",emoji:"🍞"},
  {id:8,name:"Kentang Rebus",portion:"1 buah sedang",cal:130,carb:30,protein:3,fat:0.1,cat:"Karbohidrat",emoji:"🥔"},
  {id:9,name:"Ubi Jalar Rebus",portion:"1 buah",cal:115,carb:27,protein:2,fat:0.1,cat:"Karbohidrat",emoji:"🍠"},
  // Lauk Protein
  {id:10,name:"Ayam Dada Panggang",portion:"1 potong (100g)",cal:165,carb:0,protein:31,fat:3.6,cat:"Protein",emoji:"🍗"},
  {id:11,name:"Ayam Goreng Tepung",portion:"1 potong",cal:280,carb:12,protein:22,fat:16,cat:"Protein",emoji:"🍗"},
  {id:12,name:"Telur Rebus",portion:"2 butir",cal:140,carb:1,protein:12,fat:10,cat:"Protein",emoji:"🥚"},
  {id:13,name:"Telur Dadar",portion:"2 butir",cal:180,carb:2,protein:12,fat:14,cat:"Protein",emoji:"🍳"},
  {id:14,name:"Ikan Bakar",portion:"1 ekor sedang",cal:200,carb:0,protein:34,fat:6,cat:"Protein",emoji:"🐟"},
  {id:15,name:"Tempe Goreng",portion:"3 potong",cal:170,carb:8,protein:14,fat:10,cat:"Protein",emoji:"🫘"},
  {id:16,name:"Tahu Goreng",portion:"3 potong",cal:150,carb:4,protein:10,fat:11,cat:"Protein",emoji:"🧈"},
  {id:17,name:"Rendang Daging",portion:"1 potong",cal:220,carb:3,protein:18,fat:15,cat:"Protein",emoji:"🥩"},
  {id:18,name:"Sate Ayam",portion:"5 tusuk",cal:250,carb:8,protein:20,fat:15,cat:"Protein",emoji:"🍢"},
  {id:19,name:"Ikan Tongkol Balado",portion:"1 potong",cal:180,carb:4,protein:28,fat:6,cat:"Protein",emoji:"🐟"},
  {id:20,name:"Udang Goreng",portion:"5 ekor",cal:160,carb:4,protein:22,fat:6,cat:"Protein",emoji:"🦐"},
  {id:21,name:"Greek Yogurt",portion:"1 cup (150g)",cal:130,carb:8,protein:15,fat:4,cat:"Protein",emoji:"🥛"},
  {id:22,name:"Dada Ayam Geprek",portion:"1 porsi",cal:350,carb:20,protein:28,fat:18,cat:"Protein",emoji:"🍗"},
  // Sayur & Salad
  {id:23,name:"Gado-gado",portion:"1 porsi",cal:320,carb:28,protein:14,fat:18,cat:"Sayuran",emoji:"🥗"},
  {id:24,name:"Sayur Bayam",portion:"1 mangkok",cal:45,carb:6,protein:3,fat:1,cat:"Sayuran",emoji:"🥬"},
  {id:25,name:"Sayur Asem",portion:"1 mangkok",cal:60,carb:12,protein:2,fat:0.5,cat:"Sayuran",emoji:"🍲"},
  {id:26,name:"Capcay",portion:"1 porsi",cal:120,carb:10,protein:6,fat:7,cat:"Sayuran",emoji:"🥦"},
  {id:27,name:"Tumis Kangkung",portion:"1 porsi",cal:80,carb:6,protein:3,fat:5,cat:"Sayuran",emoji:"🥬"},
  {id:28,name:"Sop Sayur",portion:"1 mangkok",cal:70,carb:10,protein:3,fat:2,cat:"Sayuran",emoji:"🍲"},
  {id:29,name:"Lalapan Mentah",portion:"1 set",cal:25,carb:5,protein:1,fat:0.2,cat:"Sayuran",emoji:"🥒"},
  {id:30,name:"Pecel",portion:"1 porsi",cal:280,carb:22,protein:10,fat:18,cat:"Sayuran",emoji:"🥗"},
  // Buah & Snack
  {id:31,name:"Pisang",portion:"1 buah",cal:90,carb:23,protein:1,fat:0.3,cat:"Snack",emoji:"🍌"},
  {id:32,name:"Apel",portion:"1 buah",cal:72,carb:19,protein:0.4,fat:0.2,cat:"Snack",emoji:"🍎"},
  {id:33,name:"Jeruk",portion:"1 buah",cal:60,carb:15,protein:1,fat:0.2,cat:"Snack",emoji:"🍊"},
  {id:34,name:"Mangga",portion:"1 buah",cal:100,carb:25,protein:1,fat:0.4,cat:"Snack",emoji:"🥭"},
  {id:35,name:"Pisang + Selai Kacang",portion:"1 porsi",cal:180,carb:30,protein:5,fat:7,cat:"Snack",emoji:"🍌"},
  {id:36,name:"Granola Bar",portion:"1 bar",cal:140,carb:22,protein:3,fat:5,cat:"Snack",emoji:"🍫"},
  {id:37,name:"Kacang Almond",portion:"1 genggam (28g)",cal:164,carb:6,protein:6,fat:14,cat:"Snack",emoji:"🥜"},
  {id:38,name:"Roti + Selai Madu",portion:"2 lembar",cal:200,carb:38,protein:5,fat:3,cat:"Snack",emoji:"🍯"},
  // Minuman
  {id:39,name:"Kopi Hitam",portion:"1 gelas",cal:5,carb:0,protein:0,fat:0,cat:"Minuman",emoji:"☕"},
  {id:40,name:"Kopi Susu Gula Aren",portion:"1 gelas",cal:150,carb:22,protein:4,fat:5,cat:"Minuman",emoji:"☕"},
  {id:41,name:"Teh Manis",portion:"1 gelas",cal:80,carb:20,protein:0,fat:0,cat:"Minuman",emoji:"🍵"},
  {id:42,name:"Susu Full Cream",portion:"1 gelas (250ml)",cal:150,carb:12,protein:8,fat:8,cat:"Minuman",emoji:"🥛"},
  {id:43,name:"Jus Jeruk Segar",portion:"1 gelas",cal:110,carb:26,protein:2,fat:0.5,cat:"Minuman",emoji:"🧃"},
  {id:44,name:"Air Kelapa",portion:"1 gelas",cal:45,carb:9,protein:2,fat:0.5,cat:"Minuman",emoji:"🥥"},
  {id:45,name:"Susu Whey Protein",portion:"1 scoop",cal:120,carb:3,protein:24,fat:1.5,cat:"Minuman",emoji:"🥤"},
  // Street Food & Warung
  {id:46,name:"Nasi Padang Komplit",portion:"1 porsi",cal:650,carb:70,protein:35,fat:25,cat:"Warung",emoji:"🍛"},
  {id:47,name:"Bakso + Mie",portion:"1 mangkok",cal:400,carb:45,protein:18,fat:15,cat:"Warung",emoji:"🍜"},
  {id:48,name:"Soto Ayam + Nasi",portion:"1 porsi",cal:380,carb:42,protein:20,fat:14,cat:"Warung",emoji:"🍲"},
  {id:49,name:"Rawon + Nasi",portion:"1 porsi",cal:420,carb:45,protein:25,fat:15,cat:"Warung",emoji:"🍲"},
  {id:50,name:"Pecel Lele + Nasi",portion:"1 porsi",cal:480,carb:50,protein:28,fat:18,cat:"Warung",emoji:"🐟"},
  {id:51,name:"Nasi Kuning Komplit",portion:"1 porsi",cal:500,carb:60,protein:18,fat:20,cat:"Warung",emoji:"🍛"},
  {id:52,name:"Bubur Ayam",portion:"1 mangkok",cal:300,carb:40,protein:15,fat:8,cat:"Warung",emoji:"🍲"},
  {id:53,name:"Mie Ayam",portion:"1 mangkok",cal:420,carb:52,protein:16,fat:16,cat:"Warung",emoji:"🍜"},
  {id:54,name:"Siomay Bandung",portion:"5 buah + bumbu",cal:280,carb:25,protein:14,fat:14,cat:"Warung",emoji:"🥟"},
  {id:55,name:"Gorengan (Bakwan)",portion:"3 buah",cal:300,carb:30,protein:5,fat:18,cat:"Warung",emoji:"🍘"},
  {id:56,name:"Martabak Telur",portion:"2 potong",cal:350,carb:25,protein:16,fat:22,cat:"Warung",emoji:"🥞"},
  // Alfamart / Indomaret
  {id:57,name:"Yakult",portion:"1 botol",cal:50,carb:12,protein:1,fat:0,cat:"Minimarket",emoji:"🧴"},
  {id:58,name:"Roti Sari Roti Coklat",portion:"1 bungkus",cal:280,carb:42,protein:6,fat:10,cat:"Minimarket",emoji:"🍞"},
  {id:59,name:"Ultra Milk 250ml",portion:"1 kotak",cal:125,carb:12,protein:7,fat:5,cat:"Minimarket",emoji:"🥛"},
  {id:60,name:"Pop Mie",portion:"1 cup",cal:340,carb:44,protein:7,fat:14,cat:"Minimarket",emoji:"🍜"},
  {id:61,name:"Energen",portion:"1 sachet",cal:130,carb:24,protein:3,fat:3,cat:"Minimarket",emoji:"☕"},
  {id:62,name:"Soyjoy",portion:"1 bar",cal:130,carb:17,protein:4,fat:5,cat:"Minimarket",emoji:"🍫"},
];
...
const TRAIN={
  beginner:[
    {day:"Senin",type:"Run/Walk",dur:"20 min",detail:"1 min lari · 2 min jalan × 6",int:"Rendah",e:"🚶"},
    {day:"Rabu",type:"Rest Aktif",dur:"30 min",detail:"Jalan santai atau stretching",int:"Sangat Rendah",e:"🧘"},
    {day:"Jumat",type:"Run/Walk",dur:"25 min",detail:"2 min lari · 2 min jalan × 6",int:"Rendah",e:"🏃"},
    {day:"Minggu",type:"Long Walk",dur:"35 min",detail:"Jalan cepat konstan",int:"Rendah",e:"🌅"},
  ],
  intermediate:[
    {day:"Senin",type:"Easy Run",dur:"30 min",detail:"Pace santai, bisa ngobrol",int:"Sedang",e:"🏃"},
    {day:"Rabu",type:"Interval",dur:"35 min",detail:"8×400m cepat + warmup/cooldown",int:"Tinggi",e:"⚡"},
    {day:"Jumat",type:"Tempo Run",dur:"30 min",detail:"15 min tempo · 5 min easy",int:"Sedang-Tinggi",e:"🔥"},
    {day:"Minggu",type:"Long Run",dur:"50 min",detail:"Pace konstan, nyaman",int:"Sedang",e:"🌅"},
  ],
  advanced:[
    {day:"Senin",type:"Recovery",dur:"40 min",detail:"Zone 2, sangat ringan",int:"Rendah",e:"🌿"},
    {day:"Selasa",type:"Speed Work",dur:"50 min",detail:"12×400m @ 5K pace",int:"Sangat Tinggi",e:"🚀"},
    {day:"Kamis",type:"Tempo Run",dur:"50 min",detail:"20 min @ threshold pace",int:"Tinggi",e:"⚡"},
    {day:"Sabtu",type:"Long Run",dur:"90 min",detail:"Pace percakapan, aerobik",int:"Sedang",e:"🏔️"},
  ]
};
...
/* ═══════════ ACHIEVEMENTS ═══════════ */
const BADGES=[
  {id:"first_log",name:"First Bite",desc:"Log makanan pertamamu",icon:"🍽️",check:d=>d.totalLogged>=1},
  {id:"day_complete",name:"Full Day Logger",desc:"Log 3+ makanan dalam sehari",icon:"📋",check:d=>d.todayLog>=3},
  {id:"week_streak",name:"7 Day Warrior",desc:"Log makanan 7 hari berturut",icon:"🔥",check:d=>d.streak>=7},
  {id:"cal_target",name:"On Target",desc:"Kalori harian tepat sasaran (±100)",icon:"🎯",check:d=>d.onTarget},
  {id:"weight_log",name:"Scale Master",desc:"Catat berat badan pertama kali",icon:"⚖️",check:d=>d.weightLogs>=1},
  {id:"protein_king",name:"Protein King",desc:"Protein harian > 100g",icon:"💪",check:d=>d.proteinToday>=100},
  {id:"hydration",name:"Water Champion",desc:"Minum 8 gelas sehari",icon:"💧",check:d=>d.hydration>=8},
  {id:"meal_plan",name:"Meal Planner",desc:"Generate meal plan pertamamu",icon:"📊",check:d=>d.mealPlanGenerated},
];
...
function generateMealPlan(targetCal,goal){
  const slots=[
  ...
  slots.forEach(slot=>{
    ...
    for(const f of shuffled){
      if(slotCal+f.cal<=budget+80&&items.length<3){items.push(f);slotCal+=f.cal;}
      if(slotCal>=budget-100||items.length>=2)break;
    }
    if(items.length===0&&shuffled.length>0)items.push(shuffled[0]);
    const sc=items.reduce((s,i)=>s+i.cal,0);
    total+=sc;
    ...
    <div style={{flex:1,padding:"16px 28px 0",display:"flex",flexDirection:"column",position:"relative",zIndex:1}}>
      ...
      <div style={{marginTop:48}}>
        <div style={{display:"inline-flex",alignItems:"center",gap:6,background:`${T.teal}15`,border:`1px solid ${T.teal}30`,borderRadius:100,padding:"5px 12px",marginBottom:14}}>
          <Sparkles size={11} color={T.teal}/><span style={{fontSize:10,color:T.teal,fontFamily:F.d,fontWeight:700,letterSpacing:1}}>AI POWERED</span>
        </div>
        ...
        <p style={{color:T.tx2,fontSize:13,lineHeight:1.6,marginTop:14}}>Hitung kalori, susun meal plan, track progress,<br/>& reminder makan — semua personal untukmu.</p>
      </div>
      <div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:8,marginTop:24}}>
        {[{i:"📊",l:"Kalori &\nMakro",c:T.coral},{i:"🍽️",l:"Meal Plan\nOtomatis",c:T.teal},{i:"🥗",l:"60+ Makanan\nIndonesia",c:T.green},{i:"📈",l:"Progress\nTracker",c:T.blue}].map((f,i)=>(
          <div key={i} style={{background:T.s,border:`1px solid ${T.b}`,borderRadius:14,padding:"12px 12px 10px",display:"flex",flexDirection:"column",gap:5}}>
            <div style={{width:30,height:30,borderRadius:8,background:`${f.c}18`,border:`1px solid ${f.c}30`,display:"flex",alignItems:"center",justifyContent:"center",fontSize:15}}>{f.i}</div>
      ...
      <div style={{paddingBottom:28}}>
        ...
        <div style={{fontSize:11,color:T.tx4,marginTop:10,textAlign:"center"}}>Gratis · No signup · Langsung jalan 🚀</div>
      </div>
    </div><HI/></div>);
}

/* ═══════════ ONBOARDING (Step 1-3) — compact ═══════════ */
function StepHdr({step,title,sub,emoji,onBack}){
  return(<div style={{padding:"8px 20px 0"}}>
    ...
    <div style={{display:"flex",alignItems:"center",gap:12}}>
      ...
      <div><div style={{fontSize:10,color:T.teal,letterSpacing:2,fontFamily:F.d,fontWeight:700}}>LANGKAH {step} / 3</div><div style={{fontFamily:F.d,fontWeight:800,fontSize:22,color:T.tx,marginTop:2}}>{emoji} {title}</div><div style={{fontSize:12,color:T.tx3,marginTop:2}}>{sub}</div></div>
    </div>
  </div>);
}
...
function Step1({data:d,setData:sd,onBack,onNext}){
  ...
  return(<div style={S.scr}><SBar/><StepHdr step={1} title="Data Diri" sub="Biar kita kenal kamu dulu!" emoji="👤" onBack={onBack}/>
    <div style={{flex:1,padding:"20px",overflowY:"auto",display:"flex",flexDirection:"column",gap:16}}>
      ...
      <div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:10}}>
        <div><label style={S.lbl}>Berat ⚖️</label><input style={S.inp} type="number" placeholder="65 kg" value={d.weight} onChange={e=>sd({...d,weight:e.target.value})}/></div>
        <div><label style={S.lbl}>Tinggi 📏</label><input style={S.inp} type="number" placeholder="168 cm" value={d.height} onChange={e=>sd({...d,height:e.target.value})}/></div>
      </div>
      <div><label style={S.lbl}>Gender</label><div style={{display:"flex",gap:8}}>{[{v:"male",l:"Cowok 🙋‍♂️"},{v:"female",l:"Cewek 🙋‍♀️"}].map(g=><button key={g.v} onClick={()=>sd({...d,gender:g.v})} style={{...S.chip(d.gender===g.v,T.teal),flex:1,padding:"14px 8px",fontSize:14}}>{g.l}</button>)}</div></div>
...
function Step2({data:d,setData:sd,onBack,onNext}){
  return(<div style={S.scr}><SBar/><StepHdr step={2} title="Fitness Level" sub="Seberapa aktif kamu?" emoji="💪" onBack={onBack}/>
    <div style={{flex:1,padding:"16px 20px",overflowY:"auto",display:"flex",flexDirection:"column",gap:14}}>
      <div><label style={S.lbl}>Level Fitness</label><div style={{display:"flex",flexDirection:"column",gap:8}}>
        {[{v:"beginner",l:"Pemula",dd:"Baru mulai / jarang olahraga",e:"🌱"},{v:"intermediate",l:"Menengah",dd:"Sering olahraga, mau ningkatin",e:"⚡"},{v:"advanced",l:"Lanjutan",dd:"Rutin latihan, mau maksimalin",e:"🔥"}].map(l=>{const a=d.fitnessLevel===l.v;return(<button key={l.v} onClick={()=>sd({...d,fitnessLevel:l.v})} style={{display:"flex",alignItems:"center",gap:12,padding:14,borderRadius:14,border:`1px solid ${a?T.teal:T.b}`,background:a?`linear-gradient(135deg,${T.teal},${T.purple}aa)`:T.s,color:a?T.bg:T.tx,cursor:"pointer",textAlign:"left",width:"100%",transition:"all .2s"}}><span style={{fontSize:22}}>{l.e}</span><div style={{flex:1}}><div style={{fontFamily:F.d,fontWeight:800,fontSize:14}}>{l.l}</div><div style={{fontSize:11,opacity:.7}}>{l.dd}</div></div>{a&&<CheckCircle size={16}/>}</button>)})}
      </div></div>
      <div><label style={S.lbl}>Aktivitas Harian</label><div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:8}}>
        {[{v:"sedentary",l:"Duduk terus",e:"🪑"},{v:"light",l:"Ringan 1-3x/mgg",e:"🚶"},{v:"moderate",l:"Sedang 3-5x/mgg",e:"🏃"},{v:"active",l:"Aktif 6-7x/mgg",e:"🏋️"}].map(a=><button key={a.v} onClick={()=>sd({...d,activityLevel:a.v})} style={{...S.chip(d.activityLevel===a.v),padding:"12px 10px",textAlign:"left",display:"flex",flexDirection:"column",gap:3}}><span style={{fontSize:16}}>{a.e}</span><span style={{fontSize:11}}>{a.l}</span></button>)}
      </div></div>
    </div>
...
function Step3({data:d,setData:sd,onBack,onNext}){
  ...
  return(<div style={S.scr}><SBar/><StepHdr step={3} title="Tujuan" sub="Mau achieve apa?" emoji="🎯" onBack={onBack}/>
    <div style={{flex:1,padding:"16px 20px",overflowY:"auto",display:"flex",flexDirection:"column",gap:14}}>
      <div><label style={S.lbl}>Target Tubuh</label><div style={{display:"grid",gridTemplateColumns:"1fr 1fr 1fr",gap:8}}>
        {[{v:"lose",l:"Turun BB",e:"🔥",c:T.coral},{v:"maintain",l:"Jaga Ideal",e:"⚖️",c:T.green},{v:"gain",l:"Naik Otot",e:"💪",c:T.blue}].map(g=>{const a=d.goal===g.v;return(<button key={g.v} onClick={()=>sd({...d,goal:g.v})} style={{padding:"14px 6px",borderRadius:14,border:`1.5px solid ${a?g.c:T.b}`,background:a?`${g.c}22`:T.s,cursor:"pointer",display:"flex",flexDirection:"column",alignItems:"center",gap:4}}><span style={{fontSize:24}}>{g.e}</span><span style={{fontFamily:F.d,fontWeight:800,fontSize:11,color:a?g.c:T.tx}}>{g.l}</span></button>)})}
      </div></div>
      <div><label style={S.lbl}>Target Lari</label><div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:8}}>
        {[{v:"5k",l:"Finish 5K 🎯"},{v:"10k",l:"Kejar 10K 🏆"},{v:"halfMarathon",l:"Half Marathon 🥇"},{v:"fitness",l:"General Fitness ❤️"}].map(g=>{const a=d.runGoal===g.v;return(<button key={g.v} onClick={()=>sd({...d,runGoal:g.v})} style={{...S.chip(a),padding:"12px",textAlign:"center"}}>{g.l}</button>)})}
      </div></div>
      <div><label style={S.lbl}>Nama 🙌</label><input style={S.inp} placeholder="Panggil aku..." value={d.name} onChange={e=>sd({...d,name:e.target.value})}/></div>
      <div style={{background:`${T.purple}18`,border:`1px solid ${T.purple}30`,borderRadius:14,padding:12}}>
        <div style={{fontFamily:F.d,fontWeight:800,fontSize:11,color:T.purple,letterSpacing:1.5,marginBottom:8}}>📊 PREVIEW</div>
        <div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:8}}>
          ...
          <div><div style={{fontSize:9,color:T.tx3}}>Latihan</div><div style={{fontFamily:F.d,fontWeight:800,fontSize:20,color:T.purple}}>{(TRAIN[d.fitnessLevel]||TRAIN.intermediate).length}x <span style={{fontSize:10,color:T.tx3}}>/mgg</span></div></div>
        </div>
      </div>
    </div>
    <div style={{padding:"14px 20px 24px"}}><button onClick={onNext} style={S.btn}>Lihat Programku <Sparkles size={14}/></button></div><HI/></div>);
}

/* ═══════════ DASHBOARD SHARED ═══════════ */
function DashHdr({data:d,accent=T.teal}){
  return(<div style={{background:`linear-gradient(135deg,${T.bg},#15151f 50%,#0f0a1f)`,padding:"14px 20px 14px",borderBottom:`1px solid ${T.b}`,position:"relative",overflow:"hidden"}}>
...
/* ═══════════ TAB 1: HOME — Calorie Budget + Daily Summary ═══════════ */
  ...
  return(<div style={S.scr}><SBar/><DashHdr data={d}/><TabBar active="home" onTab={onTab}/>
    <div style={{flex:1,overflowY:"auto",padding:"12px 14px 24px",display:"flex",flexDirection:"column",gap:10}}>
      ...
      <div style={{...S.card,background:`linear-gradient(135deg,${remaining>0?T.green:T.red}10,${T.bg})`,border:`1px solid ${remaining>0?T.green:T.red}30`}}>
        <div style={{display:"flex",justifyContent:"space-between",alignItems:"flex-start"}}>
          ...
          <div style={{textAlign:"right"}}>
            <div style={{fontFamily:F.d,fontWeight:800,fontSize:18,color:T.coral}}>{consumed.toLocaleString()}</div>
            <div style={{fontSize:10,color:T.tx3}}>dimakan</div>
          </div>
        </div>
        {/* Progress bar */}
        ...
        <div style={{display:"flex",justifyContent:"space-between",marginTop:6}}>
          ...
          {pct>1&&<span style={{fontSize:9,color:T.red,fontWeight:700}}>⚠️ Melebihi target!</span>}
        </div>
      </div>

      {/* Quick macro summary */}
      <div style={{display:"grid",gridTemplateColumns:"repeat(4,1fr)",gap:6}}>
        {[{v:consumed,u:"kcal",l:"Dimakan",c:T.coral},{v:carbT,u:"g",l:"Karbo",c:T.amber},{v:proT,u:"g",l:"Protein",c:T.green},{v:fatT,u:"g",l:"Lemak",c:T.purple}].map((s,i)=>
          <div key={i} style={{background:T.s,border:`1px solid ${T.b}`,borderRadius:12,padding:"8px 4px",textAlign:"center"}}>
            ...
            <div style={{fontSize:8,color:T.tx3}}>{s.u}</div>
            <div style={{fontSize:8,color:T.tx4}}>{s.l}</div>
          </div>)}
      </div>
      ...
      {foodLog.length>0&&<div style={S.card}>
        <div style={S.ct}><Utensils size={14} color={T.green}/> Log Hari Ini ({foodLog.length} item)</div>
        <div style={{marginTop:8,display:"flex",flexDirection:"column",gap:4}}>
          {foodLog.slice(-5).map((f,i)=><div key={i} style={{display:"flex",justifyContent:"space-between",alignItems:"center",padding:"6px 0",borderBottom:`1px solid ${T.b}`}}>
            <span style={{fontSize:11,color:T.tx}}>{f.emoji} {f.name}</span>
            <span style={{fontSize:11,color:T.coral,fontFamily:F.d,fontWeight:700}}>{f.cal}</span>
          </div>)}
          {foodLog.length>5&&<div style={{fontSize:10,color:T.tx3,textAlign:"center"}}>+{foodLog.length-5} lagi...</div>}
        </div>
      </div>}
      ...
      <div style={S.card}>
        ...
        <div style={{display:"flex",gap:6,marginTop:8}}>
          {Array.from({length:8},(_,i)=><button key={i} onClick={()=>setHydration(i<hydration?i:i+1)} style={{fontSize:20,background:"none",border:"none",cursor:"pointer",opacity:i<hydration?1:.25,transition:"all .2s"}}>💧</button>)}
        </div>
      ...
      <div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:6}}>
        {[{l:"BMI",v:bmi,s:bI.l,c:bI.c},{l:"Target",v:`${target}`,s:"kcal/hari",c:T.teal},{l:"BMR",v:`${Math.round(bmr)}`,s:"kcal",c:T.purple},{l:"Sesi/mgg",v:`${(TRAIN[d.fitnessLevel]||TRAIN.intermediate).length}x`,s:"latihan",c:T.amber}].map((s,i)=>
          <div key={i} style={{background:`${s.c}10`,border:`1px solid ${s.c}25`,borderRadius:12,padding:"10px 12px"}}>
            ...
            <div style={{fontSize:10,color:T.tx}}>{s.l}</div>
            <div style={{fontSize:9,color:T.tx3}}>{s.s}</div>
          </div>)}
      </div>
    </div><HI/></div>);
}

/* ═══════════ TAB 2: MAKAN — Food Database + Logger + Meal Planner ═══════════ */
function DashMakan({data:d,foodLog,setFoodLog,mealPlan,setMealPlan,onTab}){
  const [search,setSearch]=useState("");
  const [cat,setCat]=useState("Semua");
  const [view,setView]=useState("log"); // log | search | plan
  ...
  const genPlan=()=>{setMealPlan(generateMealPlan(target,d.goal));setView("plan")};
  ...
  return(<div style={S.scr}><SBar/><DashHdr data={d} accent={T.green}/><TabBar active="makan" onTab={onTab}/>
    <div style={{flex:1,overflowY:"auto",display:"flex",flexDirection:"column"}}>
      ...
      <div style={{display:"flex",gap:4,padding:"10px 14px 0"}}>
        {[{id:"log",l:"📋 Log Harian"},{id:"search",l:"🔍 Cari Makanan"},{id:"plan",l:"📊 Meal Plan"}].map(t=>
          <button key={t.id} onClick={()=>setView(t.id)} style={{flex:1,padding:"8px",borderRadius:10,border:`1px solid ${view===t.id?T.green:T.b}`,background:view===t.id?`${T.green}18`:T.s,color:view===t.id?T.green:T.tx3,fontSize:10,fontFamily:F.d,fontWeight:700,cursor:"pointer"}}>{t.l}</button>)}
      </div>
      ...
      <div style={{padding:"10px 14px 24px",display:"flex",flexDirection:"column",gap:10}}>
        ...
        {view==="log"&&<>
          ...
          <div style={{...S.card,padding:12}}>
            <div style={{display:"flex",justifyContent:"space-between",marginBottom:6}}>
              <span style={{fontSize:11,color:T.tx2}}>Dimakan hari ini</span>
            ...
            <div style={{height:6,background:"rgba(255,255,255,.05)",borderRadius:3}}>
              <div style={{height:"100%",width:`${Math.min((consumed/target)*100,100)}%`,background:consumed>target?T.red:`linear-gradient(90deg,${T.green},${T.teal})`,borderRadius:3,transition:"width .3s"}}/>
            </div>
          </div>
          ...
          {foodLog.length===0?
            <div style={{textAlign:"center",padding:"30px 0",color:T.tx3}}>
              ...
              <div style={{fontFamily:F.d,fontWeight:700,fontSize:14}}>Belum ada log hari ini</div>
              <div style={{fontSize:11,marginTop:4}}>Tap "Cari Makanan" untuk mulai log</div>
            </div>
            :
            foodLog.map((f,i)=><div key={i} style={{...S.card,display:"flex",alignItems:"center",gap:10,padding:10}}>
              ...
              <div style={{flex:1,minWidth:0}}>
                <div style={{fontFamily:F.d,fontWeight:700,fontSize:12,color:T.tx}}>{f.name}</div>
                <div style={{fontSize:10,color:T.tx3}}>{f.portion} · {f.carb}c {f.protein}p {f.fat}f</div>
              </div>
              <div style={{textAlign:"right",marginRight:4}}>
                <div style={{fontFamily:F.d,fontWeight:800,fontSize:14,color:T.coral}}>{f.cal}</div>
                <div style={{fontSize:8,color:T.tx3}}>kcal</div>
              </div>
              <button onClick={()=>removeFood(i)} style={{background:"none",border:"none",cursor:"pointer",color:T.tx4,padding:4}}><X size={14}/></button>
            </div>)
          }
          <button onClick={()=>setView("search")} style={{...S.btn,background:T.green,boxShadow:`0 4px 16px ${T.green}30`}}>
        ...
        {view==="search"&&<>
          <div style={{position:"relative"}}>
            <Search size={16} style={{position:"absolute",left:12,top:13,color:T.tx3}}/>
            <input value={search} onChange={e=>setSearch(e.target.value)} placeholder="Cari: nasi goreng, tempe, pisang..." style={{...S.inp,paddingLeft:36}}/>
          </div>
          <div style={{display:"flex",gap:4,flexWrap:"wrap"}}>
            {FOOD_CATS.map(c=><button key={c} onClick={()=>setCat(c)} style={{...S.chip(cat===c,T.green),padding:"6px 10px",fontSize:10}}>{c}</button>)}
          </div>
          <div style={{fontSize:10,color:T.tx3}}>{filtered.length} hasil ditemukan</div>
          {filtered.slice(0,15).map(f=><div key={f.id} style={{...S.card,display:"flex",alignItems:"center",gap:10,padding:10,cursor:"pointer"}} onClick={()=>addFood(f)}>
            ...
            <div style={{flex:1,minWidth:0}}>
              <div style={{fontFamily:F.d,fontWeight:700,fontSize:12,color:T.tx}}>{f.name}</div>
              <div style={{fontSize:10,color:T.tx3}}>{f.portion} · {f.cat}</div>
            </div>
            <div style={{textAlign:"right"}}>
              <div style={{fontFamily:F.d,fontWeight:800,fontSize:14,color:T.coral}}>{f.cal}</div>
              <div style={{fontSize:8,color:T.tx3}}>kcal</div>
        ...
        {/* ─── VIEW: MEAL PLAN ─── */}
        {view==="plan"&&<>
          <button onClick={genPlan} style={{...S.btn,background:`linear-gradient(135deg,${T.teal},${T.green})`}}>
            <RefreshCw size={14}/> Generate Meal Plan ({target} kcal)
          </button>
          {mealPlan?<>
            <div style={{...S.card,background:`${T.green}10`,border:`1px solid ${T.green}30`}}>
              <div style={{display:"flex",justifyContent:"space-between"}}>
                <div style={{fontFamily:F.d,fontWeight:800,fontSize:14,color:T.green}}>📋 Meal Plan Hari Ini</div>
                <div style={{fontFamily:F.d,fontWeight:700,fontSize:12,color:T.tx2}}>Total: {mealPlan.total} kcal</div>
              </div>
            </div>
            ...
            <div style={{...S.card,background:`${T.amber}10`,border:`1px solid ${T.amber}30`}}>
              ...
              <div style={{marginTop:8,fontSize:11,color:T.tx2,lineHeight:1.6}}>
                {[...new Set(mealPlan.slots.flatMap(s=>s.items.map(i=>i.name)))].map((n,i)=><span key={i}>{i>0?" · ":""}{n}</span>)}
              </div>
            </div>
          </>:<div style={{textAlign:"center",padding:"30px 0",color:T.tx3}}>
            <div style={{fontSize:40,marginBottom:8}}>📊</div>
            <div style={{fontFamily:F.d,fontWeight:700,fontSize:14}}>Tap tombol di atas untuk generate</div>
            <div style={{fontSize:11,marginTop:4}}>Meal plan otomatis sesuai target kalori kamu</div>
          </div>}
        </>}
      </div>
    </div><HI/></div>);
...
function DashLatihan({data:d,onTab}){
  ...
  return(<div style={S.scr}><SBar/><DashHdr data={d} accent={T.purple}/><TabBar active="latihan" onTab={onTab}/>
    <div style={{flex:1,overflowY:"auto",padding:"12px 14px 24px",display:"flex",flexDirection:"column",gap:10}}>
      <div style={S.card}>
        <div style={{display:"flex",justifyContent:"space-between",alignItems:"center"}}>
          <div style={S.ct}><Activity size={14} color={T.purple}/> Program Lari</div>
      ...
      {sess.map((s,i)=>{const dn=done[i];return(<div key={i} style={{...S.card,borderColor:dn?`${T.green}40`:T.b,background:dn?`${T.green}08`:T.s}}>
        <div style={{display:"flex",alignItems:"flex-start",gap:10}}>
          <div style={{width:44,height:44,borderRadius:12,background:`${INT_COL[s.int]}22`,border:`1px solid ${INT_COL[s.int]}44`,display:"flex",alignItems:"center",justifyContent:"center",fontSize:22,flexShrink:0}}>{s.e}</div>
          <div style={{flex:1,minWidth:0}}>
            <div style={{display:"flex",alignItems:"center",gap:6,flexWrap:"wrap"}}>
              ...
              {dn&&<span style={{fontSize:10,color:T.green}}>✓</span>}
            </div>
      ...
      <div style={{...S.card,background:`${T.amber}10`,border:`1px solid ${T.amber}30`}}>
        ...
        <div style={{display:"flex",flexDirection:"column",gap:4,marginTop:6}}>
          {["Warmup 5-10 min sebelum lari 🔥","Rule 80/20: 80% easy, 20% hard 📊","Istirahat kalau cedera ⚠️","Tidur 7-9 jam untuk recovery 😴"].map((t,i)=>
...
/* ═══════════ TAB 4: PROGRESS — Weight Chart + Streaks + Reminders + Achievements ═══════════ */
function DashProgress({data:d,foodLog,weightHistory,setWeightHistory,streak,hydration,mealPlan,onTab}){
  ...
  const addWeight=()=>{if(!newWeight)return;setWeightHistory([...weightHistory,{date:new Date().toLocaleDateString("id-ID",{day:"numeric",month:"short"}),weight:+newWeight}]);setNewWeight("")};
  ...
  const wts=weightHistory.slice(-10);
  ...
  return(<div style={S.scr}><SBar/><DashHdr data={d} accent={T.blue}/><TabBar active="progress" onTab={onTab}/>
    <div style={{flex:1,overflowY:"auto",padding:"12px 14px 24px",display:"flex",flexDirection:"column",gap:10}}>
      ...
      <div style={{...S.card,display:"flex",gap:8,alignItems:"center"}}>
        ...
        <button onClick={addWeight} style={{background:T.blue,border:"none",borderRadius:10,padding:"12px 16px",color:"#fff",fontFamily:F.d,fontWeight:700,fontSize:12,cursor:"pointer",whiteSpace:"nowrap"}}>+ Catat</button>
      </div>

      {/* Meal Reminders */}
      <div style={S.card}>
        <button onClick={()=>setShowReminders(!showReminders)} style={{width:"100%",background:"none",border:"none",cursor:"pointer",padding:0,display:"flex",justifyContent:"space-between",alignItems:"center"}}>
          <div style={S.ct}><Bell size={14} color={T.amber}/> Reminder Makan</div>
          <ChevronDown size={14} color={T.tx3} style={{transform:showReminders?"rotate(180deg)":"none",transition:"transform .2s"}}/>
        </button>
        {showReminders&&<div style={{marginTop:10,display:"flex",flexDirection:"column",gap:6}}>
          {[{t:"07:00",l:"Sarapan",e:"🌅"},{t:"10:00",l:"Snack Pagi",e:"☕"},{t:"12:30",l:"Makan Siang",e:"☀️"},{t:"15:30",l:"Snack Sore",e:"🍵"},{t:"18:30",l:"Makan Malam",e:"🌙"},{t:"21:00",l:"Evaluasi Harian",e:"📊"}].map((r,i)=>
            <div key={i} style={{display:"flex",alignItems:"center",gap:10,padding:"8px 10px",background:T.s,borderRadius:10,border:`1px solid ${T.b}`}}>
              ...
              <div style={{flex:1}}><div style={{fontFamily:F.d,fontWeight:700,fontSize:12,color:T.tx}}>{r.l}</div><div style={{fontSize:10,color:T.tx3}}>Setiap hari jam {r.t}</div></div>
          ...
          <div style={{fontSize:10,color:T.tx3,textAlign:"center",marginTop:4}}>💡 Reminder aktif saat app terinstall sebagai PWA</div>
        </div>}
      </div>
      ...
      <div style={S.card}>
        ...
        <div style={{display:"grid",gridTemplateColumns:"repeat(4,1fr)",gap:6,marginTop:10}}>
          {BADGES.map(b=>{const got=earned.find(e=>e.id===b.id);return(
            <div key={b.id} style={{textAlign:"center",padding:"8px 2px",borderRadius:10,background:got?`${T.amber}15`:T.s,border:`1px solid ${got?T.amber+"40":T.b}`,opacity:got?1:.5}}>
              <div style={{fontSize:20}}>{b.icon}</div>
              <div style={{fontSize:8,color:got?T.amber:T.tx3,fontFamily:F.d,fontWeight:700,marginTop:3,lineHeight:1.2}}>{b.name}</div>
            </div>)})}
        </div>
      </div>
      ...
      <div style={{...S.card,background:`linear-gradient(135deg,${T.purple}12,${T.teal}08)`,border:`1px solid ${T.purple}30`}}>
        <div style={S.ct}><Star size={14} color={T.purple}/> Ringkasan</div>
        <div style={{marginTop:8,fontSize:11,color:T.tx2,lineHeight:1.8}}>
          {consumed>0?<>
            📊 Kalori hari ini: <strong style={{color:T.coral}}>{consumed}</strong> / {target} kcal<br/>
            🥩 Protein: <strong style={{color:T.green}}>{proT}g</strong>{proT<(+(d.weight)||65)?" ⚠️ kurang, target min "+Math.round(+(d.weight)||65)+"g":""}<br/>
            💧 Hidrasi: {hydration}/8 gelas<br/>
            🔥 Streak: {streak} hari
          </>:<>Mulai log makanan untuk lihat ringkasan harianmu!</>}
        </div>
      </div>
    </div><HI/></div>);
}
...
function renderScreen(id,d,sd,nav,inter,extra={}){
  ...
  switch(id){
    ...
    case"home":return<DashHome data={d} foodLog={extra.foodLog||[]} hydration={extra.hydration||0} setHydration={extra.setHydration||no} onTab={n}/>;
    case"makan":return<DashMakan data={d} foodLog={extra.foodLog||[]} setFoodLog={extra.setFoodLog||no} mealPlan={extra.mealPlan} setMealPlan={extra.setMealPlan||no} onTab={n}/>;
    case"latihan":return<DashLatihan data={d} onTab={n}/>;
    case"progress":return<DashProgress data={d} foodLog={extra.foodLog||[]} weightHistory={extra.weightHistory||[{date:"Awal",weight:65}]} setWeightHistory={extra.setWeightHistory||no} streak={extra.streak||1} hydration={extra.hydration||0} mealPlan={extra.mealPlan} onTab={n}/>;
...
function PhoneFrame({children,scale=1,active=false}){
  const w=390,h=844;
  return(<div style={{width:w*scale+14,height:h*scale+14,background:"linear-gradient(135deg,#2a2a36,#0f0f15)",borderRadius:40*scale+7,padding:7,boxShadow:active?`0 0 0 2px ${T.teal},0 30px 80px ${T.teal}40`:"0 25px 60px rgba(0,0,0,.65),inset 0 0 0 1px rgba(255,255,255,.06)",transition:"all .3s",flexShrink:0}}>
    <div style={{width:w*scale,height:h*scale,borderRadius:36*scale,overflow:"hidden",background:T.bg}}>
...
function BoardView({data:d,onSelect,extra}){
  ...
  const cats=[{n:"Intro",d:"Welcome"},{n:"Onboarding",d:"3 langkah"},{n:"Main App",d:"4 tab dashboard"}];
  return(<div style={{padding:"24px 20px 50px",background:T.bg2,minHeight:"100%"}}>
    <div style={{marginBottom:28,textAlign:"center"}}>
      ...
      <h2 style={{fontFamily:F.d,fontWeight:800,fontSize:28,color:T.tx,margin:0}}>RunSync v3 · <span style={{background:`linear-gradient(90deg,${T.teal},${T.purple})`,WebkitBackgroundClip:"text",WebkitTextFillColor:"transparent"}}>8 Screens</span></h2>
...
function ProtoView({data:d,setData:sd,screen,setScreen,onExit,onReset,extra}){
  ...
  const ci=ALL_SCREENS.findIndex(s=>s.id===screen);
  const cur=ALL_SCREENS[ci];
  return(<div style={{minHeight:"100%",background:`radial-gradient(ellipse at top,#1a0a2e,${T.bg2} 60%)`,padding:"20px 16px 40px",display:"flex",flexDirection:"column",alignItems:"center"}}>
    ...
    <div style={{marginBottom:12,textAlign:"center"}}>
      ...
      <div style={{fontSize:10,color:T.tx3,marginTop:4}}><MousePointerClick size={10}/> Fully interactive</div>
    </div>
...
export default function RunSync(){
  ...
  const [weightHistory,setWeightHistory]=useState([{date:"Awal",weight:65}]);
  ...
  return(<div style={{minHeight:"100vh",background:T.bg2,fontFamily:F.b}}>
    <div style={{position:"sticky",top:0,zIndex:100,background:"rgba(5,5,7,.85)",backdropFilter:"blur(20px)",borderBottom:`1px solid ${T.b}`,padding:"12px 18px",display:"flex",alignItems:"center",justifyContent:"space-between",flexWrap:"wrap",gap:10}}>
      <div style={{display:"flex",alignItems:"center",gap:10}}><Logo s={34}/><div><div style={{fontFamily:F.d,fontWeight:800,fontSize:14,color:T.tx}}>RunSync</div><div style={{fontSize:9,color:T.tx3}}>AI Running Coach · v3</div></div></div>
